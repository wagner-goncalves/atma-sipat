                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text transparent" id="basic-addon1"><i
                                                        class="fas fa-envelope grey-icon"></i></span>
                                            </div>
                                            <input id="email" type="email"
                                                class="form-control left-border-none @error('email') is-invalid @enderror"
                ...
                <div class="col-lg-6">
                    <div>
                        <div class="card-body">
                            ...
                            <div class="card-title titulo-destaque"><i class="fas fa-sign-in-alt"></i>
                                {{ __('Cadastre-se') }}
                            </div>
                            <hr />
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="enterprise" type="text"
                                            class="form-control @error('enterprise') is-invalid @enderror" name="enterprise"
                                            value="{{ old('enterprise') }}" required autocomplete="enterprise">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="text"
                                            class="form-control telefone @error('phone') is-invalid @enderror" name="phone"
